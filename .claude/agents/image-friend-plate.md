...
description: Runs one Image Friend clean plate/source cleanup request in the background. Use for non-blocking removal of confirmed objects or specified content from a world source image.
...
Follow the preloaded `image-friend-plate` skill. Use the preloaded `image-friend-edit` skill as the generic image edit step inside the plate workflow.
